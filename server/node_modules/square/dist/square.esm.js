...
var paymentLinkRelatedResourcesSchema = /*#__PURE__*/object({
  ...
  subscriptionPlans: ['subscription_plans', /*#__PURE__*/optional( /*#__PURE__*/array( /*#__PURE__*/lazy(function () {
    return catalogObjectSchema;
  })))]
});
...
var customerCustomAttributeFilterValueSchema = /*#__PURE__*/object({
  ...
  mBoolean: ['boolean', /*#__PURE__*/optional( /*#__PURE__*/boolean())],
  address: ['address', /*#__PURE__*/optional( /*#__PURE__*/lazy(function () {
...
var customerCustomAttributeFiltersSchema = /*#__PURE__*/object({
  filters: ['filters', /*#__PURE__*/optional( /*#__PURE__*/array( /*#__PURE__*/lazy(function () {
...
var invoiceSchema = /*#__PURE__*/object({
  ...
  storePaymentMethodEnabled: ['store_payment_method_enabled', /*#__PURE__*/optional( /*#__PURE__*/boolean())]
});
...
var adjustLoyaltyPointsRequestSchema = /*#__PURE__*/object({
  ...
  allowNegativeBalance: ['allow_negative_balance', /*#__PURE__*/optional( /*#__PURE__*/boolean())]
});
...
var calculateLoyaltyPointsRequestSchema = /*#__PURE__*/object({
  ...
  loyaltyAccountId: ['loyalty_account_id', /*#__PURE__*/optional( /*#__PURE__*/string())]
});
        ...
        while (1) {
          switch (_context10.prev = _context10.next) {
            case 0:
              ...
              req.query('cursor', mapped.cursor);
              req.query('limit', mapped.limit);
              req.appendTemplatePath(_templateObject6$5(), mapped.programId);
        ...
        while (1) {
          switch (_context11.prev = _context11.next) {
            case 0:
              ...
              req.header('Content-Type', 'application/json');
              req.json(mapped.body);
              req.appendTemplatePath(_templateObject7$5(), mapped.programId);
...
var obtainTokenRequestSchema = /*#__PURE__*/object({
  ...
  clientSecret: ['client_secret', /*#__PURE__*/optional( /*#__PURE__*/string())],
  code: ['code', /*#__PURE__*/optional( /*#__PURE__*/string())],
...
var webhookSubscriptionSchema = /*#__PURE__*/object({
  ...
  notificationUrl: ['notification_url', /*#__PURE__*/optional( /*#__PURE__*/string())],
  apiVersion: ['api_version', /*#__PURE__*/optional( /*#__PURE__*/string())],
...
var subscriptionTestResultSchema = /*#__PURE__*/object({
  id: ['id', /*#__PURE__*/optional( /*#__PURE__*/string())],
  statusCode: ['status_code', /*#__PURE__*/optional( /*#__PURE__*/number())],
  payload: ['payload', /*#__PURE__*/optional( /*#__PURE__*/string())],
  createdAt: ['created_at', /*#__PURE__*/optional( /*#__PURE__*/string())],
  updatedAt: ['updated_at', /*#__PURE__*/optional( /*#__PURE__*/string())]
});
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              req.appendTemplatePath(_templateObject$w(), mapped.subscriptionId);
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              req.appendTemplatePath(_templateObject2$q(), mapped.subscriptionId);
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              req.header('Content-Type', 'application/json');
              req.json(mapped.body);
              req.appendTemplatePath(_templateObject3$k(), mapped.subscriptionId);
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              ...
              req.header('Content-Type', 'application/json');
              req.json(mapped.body);
              req.appendTemplatePath(_templateObject4$f(), mapped.subscriptionId);
...
var Client = /*#__PURE__*/function () {
  function Client(config) {
    ...
    this._userAgent = updateUserAgent('Square-TypeScript-SDK/22.0.0 ({api-version}) {engine}/{engine-version} ({os-info}) {detail}', this._config.squareVersion, this._config.userAgentDetail);
...
function getBaseUri(server, config) {
  ...
  if (config.environment === Environment.Custom) {
    if (server === 'default') {
      return pathTemplate(_templateObject$x(), new SkipEncode(config.customUrl));
    }
  }
